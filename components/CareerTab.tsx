...
const careers = [
  {
    ...
    skills: ["Java", "Spring Boot", "JSP", "MyBatis", "Vue.js", "Redis", "JWT", "MariaDB", "PostgreSQL"]
  },
  {
      ...
      <div className="w-full max-w-6xl space-y-10">
        {careers.map((item, idx) => (
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 bg-black/50 backdrop-blur-md border border-green-500 rounded-xl p-4 sm:p-6 shadow-[0_0_5px_#00ff99]"
          >
            {/* 로고 */}
            <div className="w-16 h-16 min-w-[64px] flex items-center justify-center bg-white rounded-md overflow-hidden">
              <Image
                src={item.logo}
